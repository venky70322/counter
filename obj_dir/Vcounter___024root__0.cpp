...
void Vcounter___024root___nba_sequent__TOP__0(Vcounter___024root* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    VL_WRITEF_NX("time=%0t  q=%0#\n",0,64,VL_TIME_UNITED_Q(1),
                 -12,4,(IData)(vlSelfRef.tb__DOT__q));
}
...
void Vcounter___024root___nba_sequent__TOP__1(Vcounter___024root* vlSelf) {
    ...
    vlSelfRef.tb__DOT__q = ((IData)(vlSelfRef.tb__DOT__rst)
                             ? 0U : (0x0000000fU & 
                                     ((IData)(1U) + (IData)(vlSelfRef.tb__DOT__q))));
}
...
bool Vcounter___024root___eval_phase__inact(Vcounter___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vcounter___024root___eval_phase__inact\n"); );
    Vcounter__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Locals
...
void Vcounter___024root___eval(Vcounter___024root* vlSelf) {
    ...
    do {
        ...
        do {
            ...
            vlSelfRef.__VinactPhaseResult = Vcounter___024root___eval_phase__inact(vlSelf);
